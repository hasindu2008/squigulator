...
echo "--ideal"
ex ./sigsim test/nCoV-2019.reference.fasta -o a.slow5 -n 2 --seed 1 --ideal || die "Running the tool failed"
diff -q test/dna_ideal_slow5.exp a.slow5 || die "diff failed"

echo "--ideal-time"
ex ./sigsim test/nCoV-2019.reference.fasta -o a.slow5 -n 2 --seed 1 --ideal-time || die "Running the tool failed"
diff -q test/dna_ideal_time_slow5.exp a.slow5 || die "diff failed"

echo "--ideal-amp"
ex ./sigsim test/nCoV-2019.reference.fasta -o a.slow5 -n 2 --seed 1 --ideal-amp || die "Running the tool failed"
diff -q test/dna_ideal_amp_slow5.exp a.slow5 || die "diff failed"

echo "--prefix=yes"
ex ./sigsim test/nCoV-2019.reference.fasta -o a.slow5 -n 2 --seed 1 --prefix=yes || die "Running the tool failed"
